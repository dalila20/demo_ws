...
{
  new (message_memory) my_pkg::msg::DistanciaDoisPontos(_init);
}

void DistanciaDoisPontos_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_pkg::msg::DistanciaDoisPontos *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DistanciaDoisPontos_message_member_array[2] = {
  {
    ...
    offsetof(my_pkg::msg::DistanciaDoisPontos, distanciax),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_pkg::msg::DistanciaDoisPontos, distanciay),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DistanciaDoisPontos_message_members = {
  "my_pkg::msg",  // message namespace
  "DistanciaDoisPontos",  // message name
  2,  // number of fields
  sizeof(my_pkg::msg::DistanciaDoisPontos),
...
{
  return &::my_pkg::msg::rosidl_typesupport_introspection_cpp::DistanciaDoisPontos_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_pkg, msg, DistanciaDoisPontos)() {
  return &::my_pkg::msg::rosidl_typesupport_introspection_cpp::DistanciaDoisPontos_message_type_support_handle;
}
