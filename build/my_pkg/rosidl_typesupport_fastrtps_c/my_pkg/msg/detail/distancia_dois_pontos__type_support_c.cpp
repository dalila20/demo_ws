...
#include "my_pkg/msg/detail/distancia_dois_pontos__rosidl_typesupport_fastrtps_c.h"
...
using _DistanciaDoisPontos__ros_msg_type = my_pkg__msg__DistanciaDoisPontos;
...
size_t get_serialized_size_my_pkg__msg__DistanciaDoisPontos(
  const void * untyped_ros_message,
...
static uint32_t _DistanciaDoisPontos__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_pkg__msg__DistanciaDoisPontos(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_pkg
size_t max_serialized_size_my_pkg__msg__DistanciaDoisPontos(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_my_pkg__msg__DistanciaDoisPontos(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_pkg, msg, DistanciaDoisPontos)() {
