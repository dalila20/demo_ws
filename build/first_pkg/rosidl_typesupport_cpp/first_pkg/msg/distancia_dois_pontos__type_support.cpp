...
static const _DistanciaDoisPontos_type_support_symbol_names_t _DistanciaDoisPontos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, first_pkg, msg, DistanciaDoisPontos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, first_pkg, msg, DistanciaDoisPontos)),
  }
};
...
{
  return &::first_pkg::msg::rosidl_typesupport_cpp::DistanciaDoisPontos_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, first_pkg, msg, DistanciaDoisPontos)() {
  return get_message_type_support_handle<first_pkg::msg::DistanciaDoisPontos>();
}
