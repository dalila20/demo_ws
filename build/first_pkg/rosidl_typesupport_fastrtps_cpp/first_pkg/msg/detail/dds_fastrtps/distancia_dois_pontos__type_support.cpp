...
#include "first_pkg/msg/detail/distancia_dois_pontos__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const first_pkg::msg::DistanciaDoisPontos *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<first_pkg::msg::DistanciaDoisPontos *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_first_pkg
const rosidl_message_type_support_t *
get_message_type_support_handle<first_pkg::msg::DistanciaDoisPontos>()
{
  return &first_pkg::msg::typesupport_fastrtps_cpp::_DistanciaDoisPontos__handle;
}
