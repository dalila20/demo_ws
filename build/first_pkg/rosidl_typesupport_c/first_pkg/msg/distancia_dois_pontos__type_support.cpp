...
#include "first_pkg/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _DistanciaDoisPontos_type_support_symbol_names_t _DistanciaDoisPontos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, first_pkg, msg, DistanciaDoisPontos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, first_pkg, msg, DistanciaDoisPontos)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_first_pkg
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, first_pkg, msg, DistanciaDoisPontos)() {
  return &::first_pkg::msg::rosidl_typesupport_c::DistanciaDoisPontos_message_type_support_handle;
}
