...
#include <stddef.h>
#include "first_pkg/msg/detail/distancia_dois_pontos__rosidl_typesupport_introspection_c.h"
#include "first_pkg/msg/rosidl_typesupport_introspection_c__visibility_control.h"
...
static rosidl_typesupport_introspection_c__MessageMember DistanciaDoisPontos__rosidl_typesupport_introspection_c__DistanciaDoisPontos_message_member_array[2] = {
  {
    ...
    offsetof(first_pkg__msg__DistanciaDoisPontos, distanciax),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(first_pkg__msg__DistanciaDoisPontos, distanciay),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers DistanciaDoisPontos__rosidl_typesupport_introspection_c__DistanciaDoisPontos_message_members = {
  "first_pkg__msg",  // message namespace
  "DistanciaDoisPontos",  // message name
  2,  // number of fields
  sizeof(first_pkg__msg__DistanciaDoisPontos),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_first_pkg
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, first_pkg, msg, DistanciaDoisPontos)() {
