...
: ${AMENT_CURRENT_PREFIX:="/home/mara/demo_ws/src/install/mara_utils_scripts"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mara_utils_scripts/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mara_utils_scripts/environment/path.sh"
